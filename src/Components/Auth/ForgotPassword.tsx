        ...
        <div className="flex flex-col space-y-1.5 p-6 text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            <div className="bg-blue-100 p-3 rounded-full">
              {currentStep === 1 && <Mail className="h-6 w-6 text-blue-600" />}
              {currentStep === 2 && <Shield className="h-6 w-6 text-blue-600" />}
              {currentStep === 3 && <Lock className="h-6 w-6 text-blue-600" />}
            </div>
          </div>

          {currentStep === 1 && (
            <>
              <h3 className="text-2xl font-semibold leading-none tracking-tight">Recuperar Contraseña</h3>
          ...
          {currentStep === 2 && (
            <>
              <h3 className="text-2xl font-semibold leading-none tracking-tight">Verificar Código</h3>
          ...
          {currentStep === 3 && (
            <>
              <h3 className="text-2xl font-semibold leading-none tracking-tight">Nueva Contraseña</h3>
              <p className="text-sm text-muted-foreground">Crea una nueva contraseña segura para tu cuenta</p>
            </>
          )}
        </div>
          ...
          {currentStep === 3 && (
            <form onSubmit={handlePasswordSubmit} className="space-y-4">
              ...
              <div className="text-sm space-y-2">
                <p className="font-medium text-gray-700">Requisitos de la contraseña:</p>
                <div className="space-y-2">
                  <div
                    className={`flex items-center space-x-2 ${passwordValidation.length ? "text-green-600" : "text-gray-500"}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${passwordValidation.length ? "bg-green-600 border-green-600" : "border-gray-300"}`}
                    >
                  ...
                  <div
                    className={`flex items-center space-x-2 ${passwordValidation.uppercase ? "text-green-600" : "text-gray-500"}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${passwordValidation.uppercase ? "bg-green-600 border-green-600" : "border-gray-300"}`}
                    >
                  ...
                  <div
                    className={`flex items-center space-x-2 ${passwordValidation.lowercase ? "text-green-600" : "text-gray-500"}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${passwordValidation.lowercase ? "bg-green-600 border-green-600" : "border-gray-300"}`}
                    >
                  ...
                  <div
                    className={`flex items-center space-x-2 ${passwordValidation.number ? "text-green-600" : "text-gray-500"}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${passwordValidation.number ? "bg-green-600 border-green-600" : "border-gray-300"}`}
                    >
                  ...
                  <div
                    className={`flex items-center space-x-2 ${passwordValidation.symbol ? "text-green-600" : "text-gray-500"}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${passwordValidation.symbol ? "bg-green-600 border-green-600" : "border-gray-300"}`}
                    >
