      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            Perfil seleccionado: <span className="text-blue-400 font-semibold">{getUserTypeTitle(userType)}</span>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Ingresos */}
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">¿Cuáles son tus ingresos mensuales?</label>
            <div className="relative">
              ...
              />
              <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-sm">COP</span>
            </div>
          </div>
