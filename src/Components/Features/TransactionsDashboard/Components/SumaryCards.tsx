          ...
          <div className="relative p-6">
            ...
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-2">
                <h3 className="text-gray-400 text-sm font-medium tracking-wide uppercase">{item.title}</h3>
              </div>
            ...
            <div className="flex items-center gap-2" aria-live="polite">
              ...
              <span className={`${getPercentageColor(item.percentage)} font-semibold text-sm`}>
                {formatPercentage(item.percentage)}
              </span>
              <span className="text-gray-400 text-sm">respecto al período anterior</span>
            </div>
